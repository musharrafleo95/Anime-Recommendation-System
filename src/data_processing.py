...
class DataProcessor:
    ...
    def load_data(self, usecols):
        try:
            ...
            logger.info(f"Data from file: {self.input_file} loaded successfully")
        except Exception as e:
            err_message = f"Failed to load data from file: {self.input_file}"
            logger.error(err_message)
            raise CustomException(err_message, e)
    ...
    def process_anime_data(self):
        try:
            ...
            raise CustomException("Failed to save animje and anime_synopsis data",e)
